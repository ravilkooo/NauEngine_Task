...
2. [Архитектурные решения и обоснование выбора](#архитектурные-решения-и-обоснование-выбора)
    ...
    2. [Управление памятью](#2-управление-памятью-выбор-умных-указателей)
    3. [Формат сериализации](#3-формат-сериализации-выбор-и-обоснование)
    4. [Система сериализации](#4-система-сериализации)
    5. [Интеграция языка Lua](#5-интеграция-скриптового-языка-lua)
3. [Документация](#документация)
    1. [Настройка проекта](#1-настройка-проекта)
    2. [Ресурсы](#2-ресурсы)
    3. [Сериализация](#3-сериализация)
    4. [Lua-скрипты](#4-lua-скрипты)
    5. [Добавление объектов](#5-добавление-объектов-на-сцену)
